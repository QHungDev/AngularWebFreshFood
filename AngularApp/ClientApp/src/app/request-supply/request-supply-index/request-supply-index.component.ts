...
@Component({
  selector: 'app-request-supply-index',
  templateUrl: './request-supply-index.component.html',
  styleUrls: ['./request-supply-index.component.css']
})
export class RequestSupplyIndexComponent implements OnInit {
